...
def get_weather():
	# TODO: Error handling, managee with only current, only forecast, or both, or neither.
	...
	print ">>> Forecast URL=" + str(forecast_url)
	print str(debug)
	if str(debug) == 'false':
		print ">>> NOT DEBUG, getting data from API"
		response = requests.get(current_url)
		current_json = response.content
	else:
		print ">>> DEBUG, getting mock data"
	...
	if str(debug) == 'false':
		...
		forecast_json = response.content
	else:
		print ">>> DEBUG, getting mock data"
